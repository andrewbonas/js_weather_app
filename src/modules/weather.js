...
async function openWeather() {
  ...
  try {
  const response = await fetch(`http://api.openweathermap.org/data/2.5/weather?q=${search}&appid=e6f480d766a5c383c3c37252cc5674e2`, { mode: 'cors' });
...
openWeather();
export default {openWeather, weatherButton};
